...
public class BookSearchConfig implements WebMvcConfigurer {
	...
	TopicExchange createBookSearchExchange() {
		return ExchangeBuilder
				.topicExchange("mybook.search.exchange")
				.build();
	}
